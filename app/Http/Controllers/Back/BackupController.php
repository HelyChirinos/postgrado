    ...
    public function create()
    {
        ...
        if ($exitCode == 0) {
            $notification = [
                'type' => 'info',
                'title' => 'Backups ...',
                'message' => 'Se creo el Backup satisfactoriamente.',
            ];
        ...
        return redirect()->route('back.backups.index')->with('notification', $notification);
    }
    ...
    public function download($file_name)
    {
        ...
        if ($disk->exists($file)) {
            ...
            $notification = [
                'type' => 'warning',
                'title' => 'Backups ...',
                'message' => 'No se Encontro el archivo de Respaldo.',
            ];
    ...
    public function delete($file_name)
    {
        ...
        if ($disk->exists($file)) {
            ...
            $notification = [
                'type' => 'info',
                'title' => 'Backups ...',
                'message' => 'Se elimino el archivo de Respaldo',
            ];
        } else {
            $notification = [
                'type' => 'warning',
