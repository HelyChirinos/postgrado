...
<body>
    ...
    <h5 class="text-center" style="font-size: 16px;" >Resumen de Matrículas </h5>
    <h5 class="text-center" style="font-size: 16px;" >desde el: {{formatFecha($desde)}} al: {{formatFecha($hasta)}}  </h5>
