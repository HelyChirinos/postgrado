...
@section('content')
    <div class="card mb-2">
        <div class="card-header d-print-none">
            <div class="row">
                <div class="col-11 text-center fs-5">Matriculas: del {{formatFecha($desde)}} al {{formatFecha($hasta)}} </div>
...
<script type="module">
        ...
        let pdfButton = {
            ...
            action: function(e, dt, node, config) {
                dt.state.clear();
                let url='{{ route('back.pdf.matriculas_periodo')}}';
