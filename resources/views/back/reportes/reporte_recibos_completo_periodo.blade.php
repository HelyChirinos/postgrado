...
@section('content')
    <div class="card mb-2">
        <div class="card-header d-print-none">
            <div class="row">
                <div class="col-12 text-center fs-5">Recibos desde el: {{formatFecha($desde)}} hasta el : {{formatFecha($hasta)}}</div>
            </div>
        </div>
                ...
                <div class="d-flex justify-content-between p-1 mt-2">
                    ...
                    <div id="barCenterleft">
                        <table id="resumen" class="table table-bordered table-striped datatable" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Total en Otros:</td>
                                    <td>{{formatMoney($resumen[0]->total_otros) }} Bs.</td>
                                </tr>
                    ...
                    <div id="barCentrRight">
                        <table id="100porcent" class="table table-bordered table-striped datatable" style="width: 100%; margin-bottom: 30px;">
                            <thead>
                                <tr>
                                    <th colspan="3" class="text-center">TOTAL 100%</th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                   ...
                                   @endphp
                                    ...
                                    <td>{{formatMoney($total_const*0.8)}}</td>
                                    <td>{{formatMoney($total20)}}</td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                   ...
                                   @endphp
                                    ...
                                    <td>{{formatMoney($total20*0.8)}}</td>
                                    <td>{{formatMoney($total20*0.2)}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<script type="module">
        ...
        let pdfButton = {
            ...
            action: function(e, dt, node, config) {
                dt.state.clear();
                let url='{{ route('back.pdf.recibos_completo_periodo')}}';
                let newTab = document.createElement('a');
                newTab.href = url+'?desde='+desde+'&hasta='+hasta;
