...
@section('content')
    <div class="card mb-2">
        <div class="card-header d-print-none">
            <div class="row">
                <div class="col-11 text-center fs-5">Aranceles: {{$periodo}}</div>
            ...
            <div class="col">
                <table id="sqltable" class="table table-bordered table-striped table-sm table-hover dataTable" style="width: 80%">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="p-3 text-center text-bold">NO HAY CONSTANCIAS REGISTRADAS.</td>
                            </tr>
                        @endforelse
                    </tbody>
                    <tfoot>
                ...
                <div class="d-flex justify-content-between p-1 mt-2">
                    ...
                    <div id="barCentrRight">
                        ...
                        <table id="100porcent" class="table table-bordered table-striped datatable" style="width: 100%; margin-bottom: 30px;">
                            <thead>
                                <tr>
                                    <th colspan="3" class="text-center">TOTAL CONSTANCIAS-100%</th>
                                </tr>
                                <tr>
...
<script type="module">
        ...
        let pdfButton = {
            ...
            action: function(e, dt, node, config) {
                dt.state.clear();
                let url='{{ route('back.pdf.aranceles_mes')}}';
