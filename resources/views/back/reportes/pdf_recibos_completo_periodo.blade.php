...
<body>
    ...
    <div id="footer">
        <div class="container" >
            <div style="width: 100%; font-size:10px; border-top: 1px solid rgb(80, 77, 77); padding:0px; margin:-10px;" >
    ...
    <h5 class="text-center" style="font-size: 16px;">Resumen de Recibos (Arancel y Matícula) </h5>
    <h5 class="text-center" style="font-size: 16px;">Desde el: {{formatFecha($desde)}} Hasta el: {{formatFecha($hasta)}}   </h5>
