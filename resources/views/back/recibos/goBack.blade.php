                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-1 no-gutters">
                            <div class="form-group col-md-4">  
                                ...
                                <input id="concepto" name="concepto" type="text" class="form-control" value="{{$concepto}}" >
                            </div>
                            <div class="form-group col-md-4"> 
                                <label for="paginas" class="col-form-label"  >No.Páginas</label>
                                <div class="row">
                                    <input id="paginas" style="width:50%" name="pag_prog" type="number" value="{{$pag_prog}}" placeholder="Programas" class="form-control" >
                                    <input id="pensum" style="width:50%" name="pag_pensum" type="number" value="{{$pag_pensum}}"  placeholder="Pensum" class="form-control" >
                                </div>    
                            </div>    
                            <div class="form-group col-md-4"> 
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    class="form-control" placeholder="No. Comprobante 1" 
                                    value="{{$depositos[0]['no_deposito']}}" style="height:38px;">
                            ...
                            <div class="col-md-4">
                                <input id="monto1" name="monto[]" placeholder="Monto 1" type="text" 
                                data-type="currency" class="form-control" 
                                value="{{formatMoney($depositos[0]['monto'])}}"  required >
                            </div>                                          
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    class="form-control" placeholder="No. Comprobante 2" 
                                    value="{{($long>1) ? $depositos[1]['no_deposito'] : ''}}"  style="height:38px;">
                                    <button  class="btn btn-outline-primary btn-sm" style="height:38px;"
                            ...
                            <div class="col-md-4">
                                <input id="monto2" name="monto[]" placeholder="Monto 2" type="text" 
                                data-type="currency" class="form-control" 
                                value="{{($long>1) ? formatMoney($depositos[1]['monto']) : ''}}">
                            </div>                                          
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    class="form-control" placeholder="No. Comprobante 3" 
                                    value="{{($long>2) ? $depositos[2]['no_deposito'] : ''}}" style="height:38px;">
                                    <button  class="btn btn-outline-primary btn-sm" style="height:38px;"
                            ...
                            <div class="col-md-4">
                                <input id="monto3" name="monto[]" placeholder="Monto 3" type="text" 
                                data-type="currency" class="form-control" 
                                value="{{($long>2) ? formatMoney($depositos[2]['monto']) : ''}}"  >
                            </div>                                          
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    class="form-control" placeholder="No. Comprobante 4" 
                                    value="{{($long>3) ? $depositos[3]['no_deposito'] : ''}}" style="height:38px;">
                                    <button  class="btn btn-outline-primary btn-sm" style="height:38px;"
                            ...
                            <div class="col-md-4">
                                <input id="monto4" name="monto[]" placeholder="Monto 4" type="text" 
                                data-type="currency" class="form-control" 
                                value="{{($long>3) ? formatMoney($depositos[3]['monto']) : ''}}" >
                            </div>                                          
                        </div>                                          
                    </div>
                </div>
