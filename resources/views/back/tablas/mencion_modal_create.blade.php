<div>
    <div class="row">
        <div class="col-lg-7">
            <form method="POST" action="{{ route('back.menciones.store') }}">
                @csrf
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input id="mencion" name="mencion" type="text" style="text-transform:uppercase"  class="form-control @error('mencion') is-invalid @enderror" value="" required>
