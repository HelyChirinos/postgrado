<div>
    <div class="row">
        <div class="col-lg-7">
            <form method="POST" action="{{ route('back.programas.store') }}">
                @csrf
                <div class="card mb-2">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">Agregar - Programas</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="nombre" name="nombre" type="text" style="text-transform:uppercase"  class="form-control @error('programa') is-invalid @enderror" value="" required>
