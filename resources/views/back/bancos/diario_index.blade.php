...
@push('scripts')
    ...
    <script type="module">
        ...
        if (userCanDiario) {
            ...
            let diarioButton = {
                className: 'btn-success',
                text: '<i class="fa-light fa-upload" style="margin-right:8px;"></i>  Subir Otro Archivo Diario',
       ...
       if (userCanConcilia) {
        ...
        let dtOverrideGlobals = {
            ...
            layout: {
                ...
                topStart: {
                    pageLength: {
                        menu: [[25, 50, 75, 100, -1], [25, 50, 75, 100, 'Todos']] 
                    },
                    div:{
                        className: 'dt-length',
                        id: 'SelectConsigna',
            ...
            initComplete: function (settings, json) {
                ...
                var opciones_ids = [{"": 'Todos'}, {1: 'Consignados'}, {0: 'Pendientes'}];
