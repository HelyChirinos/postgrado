...
@push('scripts')
    ...
    <script type="module">
       const canAddArancel = {{(auth()->user()->can('Agregar Aranceles')) ? "true" : "false" }};
       const canUpdateArancel = {{ auth()->user()->can('Modificar Aranceles') ? "true" : "false" }};
       const canDeleteArancel = {{ auth()->user()->can('Eliminar Aranceles') ? "true" : "false" }};
     ...
     <script type="module">
       const canAddMatricula = {{(auth()->user()->can('Agregar Matrículas')) ? "true" : "false" }};
       const canUpdateMatricula = {{ auth()->user()->can('Modificar Matrículas') ? "true" : "false" }};
       const canDeleteMatricula = {{ auth()->user()->can('Eliminar Matrículas') ? "true" : "false" }};
