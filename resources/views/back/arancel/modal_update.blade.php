                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="montov" name="montov" data-type="currency" type="numeric" placeholder=""
                                  class="form-control @error('montov') is-invalid @enderror" value="{{formatMoney($arancele->monto_venezolano)}}" required >
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                ...
                                class="form-control @error('montoe') is-invalid @enderror" value="{{formatMoney($arancele->monto_extranjero)}}" required >
