<div>
    <div class="row">
        <div class="col-lg-7">
            <form method="POST" action="{{ route('back.usuarios.update', [$usuario->id]) }}"  enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card mb-2">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">Actualizar - Usuario </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="nombre" name="nombre" type="text" class="form-control  @error('nombre') is-invalid @enderror"  value="{{ $usuario->nombre }}" required autofocus>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="apellido" name="apellido" type="text" class="form-control @error('apellido') is-invalid @enderror" value="{{ $usuario->apellido }}" required>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="cedula" name="cedula" type="text" class="form-control @error('cedula') is-invalid @enderror" value="{{ $usuario->cedula }}" required>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ $usuario->email}}" required>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="telefono" name="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" value="{{$usuario->telefono}}" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                value="{{$usuario->fecha_nac != null ? $usuario->fecha_nac->toDateString() : ' '}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <select class="form-select" name="is_propietario" id="is_propietario">
                                    <option value="0" @if ($usuario->is_propietario == 0) selected @endif>No</option>
                                    <option value="1" @if ($usuario->is_propietario == 1) selected @endif>Si</option>
                                </select>                          
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-2">
                ...
                <div class="card-body">
                    <ul>
                        ...
                        <li>Click boton <strong>Actualizar</strong> para Grabar los datos.</li>
