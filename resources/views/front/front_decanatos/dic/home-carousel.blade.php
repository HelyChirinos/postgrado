<div class="card mb-2">
    <div class="card-header">
        <div class="row">
            <div class="col">Dirección de Postgrado Decanato Ingeniería Civil</div>
        ...
        <div id="MyCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('img/decanatos/ing_civil/portatil2.png') }}" class="d-block w-100" alt="001">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Maestría en Estructural</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('img/decanatos/ing_civil/civil1.jpg') }}" class="d-block w-100" alt="002">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Maestría Gerencia de Construcción</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('img/decanatos/ing_civil/civil2.jpg') }}" class="d-block w-100" alt="003">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Maestría en Recursos Hidráulicos</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('img/decanatos/ing_civil/civil3.jpg') }}" class="d-block w-100" alt="003">
                    <div class="carousel-caption d-none d-md-block">
                        <h5> </h5>
                    </div>
                </div>
    ...
    <div class="card-footer">
        @if(session('locale')=='en')
            <div class="row ">
                <div class="col small">
                    <a href="https://www.ucla.edu.ve" target="_blank">www.dic.post-ucla.com</a>
                </div>
        ...
        @else
            <div class="row ">
                <div class="col small">
                    <a href="https://www.tuempresa.com" target="_blank">www.dic.postrado-ucla.edu.ve</a>
                    <a href="mailto://dic@ucla.edu.ve" target="_blank">dic.postgrado@ucla.edu.ve</a>
                ...
                <div class="col text-end">
                    Decanato de Ing. Civil <br>Prolongación Avenida La Salle<br/> Barquisimeto, Lara<br />Venezuela
                </div>
            </div>
        @endif
    </div>
